          ...
          <div className="flex flex-col justify-center">
            ...
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: (aboutData?.text || "ロペスジムは、心身ともに健康的な生活を実現するためのプライベートジムです。経験豊富なトレーナーが、一人ひとりの目標や生活スタイルに合わせたオーダーメイドのトレーニングプログラムを提供します。充実した設備と快適な空間で、あなたの理想の体づくりをサポートします。").replace(/\n/g, '<br>')
              }}
            ></p>
